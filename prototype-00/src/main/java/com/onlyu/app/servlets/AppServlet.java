...
public class AppServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 8284193824855795651L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        log.info(">>> doGet <<<");
        log.info(String.format("Showing 3 JNDI sample environment entries as <Boolean>, <Integer> and <String>, which are [%b], [%d] and [%s] respectively",
            JndiUtil.getBoolean("test.jndi.boolean.var"),
            JndiUtil.getInt("test.jndi.integer.var"),
            JndiUtil.getString("test.jndi.string.var")));
    }
